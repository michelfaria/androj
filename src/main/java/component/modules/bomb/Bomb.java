...
public class Bomb {
    ...
    Bomb(User victim, TextChannel channel, Integer detonationTime,
         Consumer<Bomb> onExplode, Consumer<Bomb> onDefuse, List<WireColors> wireColors,
         WireColors correctWire) {
        this.victim = victim;
