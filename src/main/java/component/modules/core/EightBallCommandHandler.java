...
public class EightBallCommandHandler extends AbstractCommandHandler implements RegisteredCommandHandler {
	...
	private static final String[] fortunes = new String[] { "It is certain", "It is decidedly so", "Without a doubt",
	...
	public EightBallCommandHandler(CommandHandlingFacadeBuilder builder, Random random) {
		this.random = random;
		this.facade = builder.setCmdId("8ball").setReplier(new DecoratedReplier(":8ball:"))
